...
<div id="menubar">
	...
	<div>
        ...
        <a href="#" class="cdx" name="adv_panel">广告设置</a><br />
         <a href="#" class="cdx" name="liuliang_panel">流量分析</a><br />
         <a href="#" class="cdx" name="peizhi_panel">站点配置</a><br />
		 <a href="#" class="cdx" name="theme_panel">主题设定</a><br />
	</div>
    ...
    <div>
    	<a href="#" class="cdx" name="reply_panel">我的留言</a><br/><a href="#" class="cdx" name="all_comment_panel">宝贝留言</a>         <br/><a href="#" class="cdx" name="reply_lookfor_panel">求购留言</a>         <br/><a href="#" class="cdx" name="reply_reply_panel">留言回复</a>         <br/></div>
	<h3><a id="a_information" href="#"><div class="img"></div>资料</a></h3>
	<div>
		<a class="cdx" name="infor_panel" href="#">我的资料</a><br />
		<a class="cdx" name="user_panel" href="#">用户管理</a>
