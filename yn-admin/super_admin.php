    ...
    <div id="menubar_logo">
      <img src="image/yinong_admin_logo.png" />
       ...
       <div class="hide_bar" id="bar_control">
         ...
         <li><a href="#" class="cdx" name="adv_panel">广告设置</a></li>
         <li><a href="#" class="cdx" name="liuliang_panel">流量分析</a></li>
         <li><a href="#" class="cdx" name="peizhi_panel">站点配置</a></li>
		 <li><a href="#" class="cdx" name="theme_panel">主题设定</a></li>
         </ul>
       </div>
       ...
       <div class="hide_bar" id="bar_leaveword">
        	<ul>
             <li><a href="#" class="cdx" name="reply_panel">我的留言</a></li>
          	 <li><a href="#" class="cdx" name="all_comment_panel">宝贝留言</a>         </li>
       ...
       <div class="hide_bar" id="bar_information">
          <ul>
            ...
            <li><a class="cdx" name="user_panel" href="#">用户管理</a></li>
          </ul>
       </div>
     </ul>
  </div><!--menubar-->
