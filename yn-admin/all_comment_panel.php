...
<div id="zjbelly" class="small_panel ui-widget-content ui-corner-all showbox">
  <h3 class="ui-widget-header ui-corner-all">全站留言</h3>
		<button type="button" id="edit_on">删除</button>
  <table id="comment_panel">
    
  </table>  
  <?php
	$pagerid='pager';
	$page_kind='comment';  //取得元素的状态
	$page_status='on';
	$pages_each=7;
	$table_id='comment_panel';
	$core_id='all_comment_page';
