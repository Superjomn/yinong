...
<body>
  ...
  <table><tr><td valign="top">
   <div id="barleft" class="small_bar ui-widget-content ui-corner-all" style="background-color:#fff; padding-left:10px; float:left;">
   		<h3 class="qiugou ui-widget-header ui-corner-all" style="padding:5px; text-align:center;">宝贝信息</h3>
