...
<body>
  <div id="wrapper" style="border:none;">
    <?php get_header();?>
    <div id="lookfor_list" class="small_bar ui-widget-content ui-corner-all" style="background-color:#fff;">
    	     <h3 class="qiugou ui-widget-header ui-corner-all" style="text-align:center;">求购信息列表</h3> 
      <ul class="lookfor_ul">
